...
export class DerivarModalComponent implements OnInit {
    ...
    constructor(
        ...
        this.seguimientoForm = this.fb.group({
            ...
            nro_hoja_ruta: [null, Validators.required],
    ...
    getTipoObservacion() {
        this.observationsFormArray.clear(); // Limpio antes el form array para q no vuelva a hacer un push nuevamente en los datos ya existentes
    ...
    // Método para encontrar campos inválidos
    private findInvalidControls(formGroup: FormGroup): string[] {
        ...
        Object.keys(formGroup.controls).forEach(controlName => {
            ...
            // Si es un FormGroup anidado, busca recursivamente
            if (control instanceof FormGroup) {
                invalidControls.push(...this.findInvalidControls(control));
            }
            // Si es un FormArray, analiza sus hijos
            ...
            // Verifica si el control actual es inválido
